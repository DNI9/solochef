            ...
            <div className="pt-2 border-t border-black/5 pb-4">
              ...
              <div className="flex flex-col gap-2.5">
                <button
                  ...
                  className="min-h-[48px] w-full flex items-center justify-center gap-2 bg-orange-500 hover:bg-orange-600 active:scale-[0.98] text-white px-4 py-2.5 rounded-xl font-bold text-sm shadow-xs transition-all cursor-pointer select-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-500"
                >
                ...
                >
                  <a
                    ...
                    aria-label={`Search ${data.title} recipe on YouTube (opens in new tab)`}
                    className="min-h-[44px] w-full flex items-center justify-center gap-2 bg-red-50 hover:bg-red-100/80 active:scale-[0.98] text-red-700 border border-red-200/70 px-3 py-2.5 rounded-xl font-bold text-xs shadow-xs transition-all cursor-pointer select-none truncate focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      width="18"
