    ...
    <div className={`w-full flex flex-col gap-2 ${className}`}>
      <div className="flex items-center gap-2">
        <motion.button
          ...
          className="min-h-[44px] flex-1 flex items-center justify-center gap-2 bg-zinc-900 hover:bg-zinc-800 text-white px-4 py-2.5 rounded-xl font-bold text-xs shadow-xs border border-zinc-800/80 transition-all cursor-pointer select-none disabled:opacity-75"
        >
          <svg
            viewBox="0 0 24 24"
            width="16"
          ...
          <span className="tracking-wide">Ask Gemini</span>
          <span className="text-[10px] font-semibold text-zinc-400 bg-white/10 px-1.5 py-0.5 rounded-md">
            AI Chef
          </span>
        </motion.button>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.94 }}
          className="min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl bg-white/80 hover:bg-white border border-black/5 text-zinc-700 shadow-2xs transition-all cursor-pointer"
          ...
          >
            <div className="bg-white/70 backdrop-blur-xs border border-black/5 rounded-2xl p-3.5 text-left shadow-2xs">
              ...
              <div
                ...
                className="select-all p-3 bg-black/5 rounded-xl text-xs font-mono text-zinc-800 leading-relaxed max-h-40 overflow-y-auto whitespace-pre-wrap cursor-pointer border border-black/5"
